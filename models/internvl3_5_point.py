...
from models.sonata_encoder import Sonata
...
class InternVLForConditionalGeneration(InternVLPreTrainedModel, GenerationMixin):
    ...
    def __init__(
        ...
        self.point_projector = PointProjector(512, config.text_config.hidden_size)
    ...
    def load_pointbackbone(
        self, ckpt_path
    ):
        self.point_backbone.load_state_dict(torch.load(ckpt_path, map_location='cpu'), strict=True)
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        labels: [bs, seq_len]
        input_pcd: [bs, point_num, 9] (coord, xyz, rgb)
        """
...
# dataset = SpatialLMDataset(processor_path='/home/haibo/haibo_workspace/weights/InternVL3_5-1B-HF',)
...
#     )
# model.point_backbone.load_state_dict(torch.load('/home/haibo/haibo_workspace/weights/sonata/spatiallm_qwen_0_5B_sonata.pth', map_location='cpu'), strict=True)
# """
# must load weight outside the model, otherwise NAN!!!!
# """
# model.to(device)
