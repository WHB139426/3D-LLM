...
class Sonata(PointModule, PyTorchModelHubMixin):
    def __init__(
        ...
        # fourier encode positional embedding in addition to Sonata
    ...
    def forward(self, data_dict):
        ...
        # print(point.keys())
        # print(point['coord'].shape, point['grid_coord'].shape, point['feat'].shape, point['batch'].shape, point['offset'].shape, )
        ...
        return context, point["grid_coord"]
...
# )
# point_backbone.load_state_dict(torch.load('/home/haibo/haibo_workspace/weights/sonata/spatiallm_qwen_0_5B_sonata.pth', map_location='cpu'), strict=True)
# point_backbone.to(device)
# # point_backbone = Sonata.from_pretrained("/home/haibo/haibo_workspace/weights/sonata").to(device)
# print(get_parameter_number(point_backbone))

# from datasets.spatiallm import SpatialLMDataset
# from mm_utils.utils import *
# dataset = SpatialLMDataset(processor_path='/home/haibo/haibo_workspace/weights/Qwen3-0.6B',)
# item = random.choice(dataset)

# point_cloud = item['input_pcd']
# print(item['scene_id'])
...
# }
# encoded_features = point_backbone(input_dict)
