...
from mm_utils.constants import DEFAULT_IMAGE_TOKEN, MULTI3DREF_PROMPT
...
class Multi3DRefDataset(Dataset):
    def __init__(
        self,
        ...
        self.annos = [item for item in raw_annos if item['scene_id']!='scene0533_00' and len(item['object_ids'])!=0] # 'scene0533_00' missing in the scannet-frames
    ...
    def __getitem__(self, i):
        ...
        object_ids = self.annos[i]["object_ids"]
        object_name = self.annos[i]["object_name"]
        description = self.annos[i]["description"]
